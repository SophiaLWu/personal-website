...
$(document).ready(function() {
  ...
  var projectsSlider = new Slider(10, "projects");
  projectsSlider.init();
  ...
  function addPortfolioDescriptions() {
    ...
    $("div[data-slide-num='5']").find(".project-description").append("<a href='https://infinite-fortress-13459.herokuapp.com/'>FLIGHTBOOKER</a>: Ruby on Rails flight searching and booking web app"); 
    $("div[data-slide-num='5']").find("img").wrap("<a href='https://infinite-fortress-13459.herokuapp.com/'></a>");
    ...
    $("div[data-slide-num='7']").find(".project-description").append("<a href='https://sophialwu.github.io/snake-game/'>SNAKE</a>: JavaScript/jQuery web game");
    $("div[data-slide-num='7']").find("img").wrap("<a href='https://sophialwu.github.io/snake-game/'></a>");
    $("div[data-slide-num='8']").find(".project-description").append("<a href ='https://sophialwu.github.io/tic-tac-toe/'>TIC-TAC-TOE</a>: minimalist web game built with JavaScript/jQuery");
    $("div[data-slide-num='8']").find("img").wrap("<a href='https://sophialwu.github.io/tic-tac-toe/'></a>");
    $("div[data-slide-num='9']").find(".project-description").append("<a href='https://rawgit.com/SophiaLWu/project-javascript-jquery/master/index.html'>ETCH-A-SKETCH</a>: JavaScript/jQuery web app");
    $("div[data-slide-num='9']").find("img").wrap("<a href='https://rawgit.com/SophiaLWu/project-javascript-jquery/master/index.html'></a>");
    $("div[data-slide-num='10']").find(".project-description").append("<a href='https://github.com/SophiaLWu/zuma-game'>ZUMA</a>: Puzzle game built using Python's Tkinter GUI");
    $("div[data-slide-num='10']").find("img").wrap("<a href='https://github.com/SophiaLWu/zuma-game'></a>");
  }
